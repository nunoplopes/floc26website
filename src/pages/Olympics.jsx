                        ...
                        <ul>
                            <li>
                                <details>
                                    ...
                                    <hr/>
                                    <b>FLoC Modeling Contest 2026</b><br/>
                                    The Programming Contest 2026 will host a live modeling
                                    contest. See: <a href="https://lpcp-contest.github.io/"
                                                     className="text-indigo-600 hover:underline">https://lpcp-contest.github.io/</a>
                                    <hr/>
                                </details>
                            </li>
                            <li>
                                <details>
                                    ...
                                    <a href="https://derby.minizinc.dev" className="text-indigo-600 hover:underline"> derby.minizinc.dev </a>
