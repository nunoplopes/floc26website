      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-1 gap-12 items-center">
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <p className="text-xl text-neutral-600 leading-relaxed">
              The Federated Logic Conference (FLoC) unites the ten leading international conferences
              focused on mathematical logic and its applications in computer science.
            </p>

            <p className="text-xl text-neutral-600 leading-relaxed">
              Since 1996, FLoC is organized every four years and counts with over 2,000 attendees.
            </p>

            <p className="text-xl text-neutral-600 leading-relaxed">
              Looking ahead, FLoC is set to take place in Portugal in 2026, highlighting the
