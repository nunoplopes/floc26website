        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <div className="p-6 mt-20">
              ...
              <p className="text-gray-600 mb-4">
                From the Ben Gurion Airport train station, located near the arrivals hall, take a
                direct train to Hof HaCarmel station in Haifa.
              </p>
              <InfoBox icon={MdAccessTime} text="Not available on Fridays and Saturdays" />
              <a
          ...
          >
            <div className="relative h-48 w-full">
              <img src="bus.png" alt="Bus transportation" className="object-cover w-full h-52" />
            </div>
            <div className="p-6 ">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Bus Service</h3>
              <p className="text-gray-600 mb-4">
                Take the 905 bus to Hof HaCarmel station in Haifa. From there, take a city bus or
