    ...
    <header className='flex items-center justify-between z-10 p-5 bg-white'>
        ...
        >
            ...
            className='flex flex-col md:flex-row gap-4 md:gap-8 mt-16 md:mt-0'>
              ...
              whileTap={{ scale: 0.95 }}
                >Programs</li></Link>
                <Link to='/registeration'><li
                whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
                >Registeration</li></Link>
                <Link to='/accomodation'><li
                whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
                >Accomodation</li></Link>
                <Link to='/venue'><li
                whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
                >Venue</li></Link>
                <Link to='/transportation'><li
                whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
                >Transportation</li></Link>
                <Link to='/tourism'><li
                whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
                >Tourism</li></Link>
