...
export const committeeData = {
  ...
  conferenceCommittees: [
    { name: 'Philipp Ruemmer', image: PHILIPP, affiliation: 'University of Regensburg', role: 'CAV Conference Chair', webpage: 'http://www.philipp.ruemmer.org' },
  ...
  steeringCommittee: [
    { name: 'Rajeev Alur', image: RAJEEV, affiliation: 'University of Pennsylvania', role: 'General Chair', webpage: 'https://www.cis.upenn.edu/~alur/' },
    { name: 'Alexandra Silva', image: ALEXANDRA, affiliation: 'Cornell University', role: 'Advisory Chair', webpage: 'https://alexandrasilva.org' },
    { name: 'Daniel Kröning', image: DANIEL, affiliation: 'University of Oxford', role: 'CAV Representative', webpage: 'https://www.kroening.com' },
    { name: 'Hélène Verhaeghe', image: HELEN, affiliation: 'KU Leuven', role: 'CP Representative', webpage: 'https://hverhaeghe.bitbucket.io' },
    { name: 'Dominique Unruh', image: DOMINIQUE, affiliation: 'University of Tartu', role: 'CSF Representative', webpage: 'https://kodu.ut.ee/~unruh/' },
    { name: 'Patrick Baillot', image: PATRICK, affiliation: 'CNRS/Université de Lille', role: 'FSCD Representative', webpage: 'https://pro.univ-lille.fr/patrick-baillot/' },
    { name: 'Marco Gavanelli', image: MARCO, affiliation: 'Università degli Studi di Ferrara', role: 'ICLP Representative', webpage: 'https://docente.unife.it/docenti-en/marco.gavanelli?set%5Flanguage=en' },
    { name: 'Franz Baader', image: FRANZ, affiliation: 'TU Dresden', role: 'IJCAR Representative', webpage: 'https://tu-dresden.de/ing/informatik/thi/lat/die-professur/franz-baader' },
    { name: 'Magnus Myreen', image: MAGNUS, affiliation: 'Chalmers University', role: 'ITP Representative', webpage: 'https://www.cse.chalmers.se/~myreen/' },
    { name: 'Esra Erdem', image: ESRA, affiliation: 'Sabanci University', role: 'KR Representative', webpage: 'https://people.sabanciuniv.edu/esraerdem/' },
    ...
    { name: 'Matthias Thimm', image: MATTHAIS, affiliation: 'FernUniversität in Hagen', role: 'NMR Representative', webpage: 'https://www.mthimm.de' },
    { name: 'Armin Biere', image: ARMIN, affiliation: 'University of Freiburg', role: 'SAT Representative', webpage: 'https://cca.informatik.uni-freiburg.de/biere/' },
  ],
};